classdef Environment_features_7_minimax < rl.env.MATLABEnvironment
    ...
    %% Necessary Methods
    methods              
        function this = Environment_features_7_minimax()
...
%          STEPS START WITH RL
        function [Observation,Reward,IsDone,LoggedSignals] = step(this,Action) 
            ...
            additional_row = transform_matrix_features_env7(Board);
