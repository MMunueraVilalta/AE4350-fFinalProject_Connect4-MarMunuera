...
function [agent] = PG_agent(obsInfo, actInfo, use_default_neural_network, standard_agent_options, options)
% PG_AGENT 
    ...
    if use_default_neural_network
        ...
        if standard_agent_options
            ...
            agent = rlPGAgent(obsInfo,actInfo, options);
        end
        ...
        if standard_agent_options
            ...
            agent = rlPGAgent(actor,critic, options);
        end
