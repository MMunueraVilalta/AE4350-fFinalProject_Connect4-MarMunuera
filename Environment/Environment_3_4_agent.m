classdef Environment_3_4_agent < rl.env.MATLABEnvironment
    %% By Mar Munuera - last updated 30/08/2023
    % ENVIRONMENT simulates a Connect4 game in MATLAB where the
    % reinforcement learning agent plays against the agent algorithm player.
    ...
    %% Necessary Methods
    methods              
        function this = Environment_3_4_agent()
