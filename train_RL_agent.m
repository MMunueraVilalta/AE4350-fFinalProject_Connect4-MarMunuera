...
agent_filename = "DQN/savedAgents/Env7_myNet_LearnRate0001_Entropy09_NumStepsToLookAhead_1_discountFactor2e3_TargetUpdate5.mat";
params_filename= "DQN/savedParameters/Env7_myNet_LearnRate0001_Entropy09_NumStepsToLookAhead_1_discountFactor2e3_TargetUpdate5.mat";
...
if agent_to_use== "DQN"    
    ...
    options = rlDQNAgentOptions(CriticOptimizerOptions=criticOpts, TargetUpdateFrequency=5, NumStepsToLookAhead=1, DiscountFactor=2e-3); %TargetUpdateFrequency=100, %  MiniBatchSize=256
    options.EpsilonGreedyExploration.Epsilon = 0.9;
