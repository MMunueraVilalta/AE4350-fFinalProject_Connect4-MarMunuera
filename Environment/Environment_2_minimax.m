classdef Environment_2_minimax < rl.env.MATLABEnvironment
    ...
    %% Necessary Methods
    methods              
        function this = Environment_2_minimax()
...
%          STEPS START WITH RL
        function [Observation,Reward,IsDone,LoggedSignals] = step(this,Action) 
            ...
            % board is not full yet.
                ...
                if win
                    Reward = this.PenaltyForLoosing + action_choice; 
                    IsDone = true;
