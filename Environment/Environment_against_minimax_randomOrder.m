classdef Environment_against_minimax_randomOrder < rl.env.MATLABEnvironment
    ...
    properties
        ...
        agent_starts_game=false;

        % Introduce randomness to the player 
        randomness=0.05;
        
        % % Set the rewards to be obtained
        % RewardForWinning=1;
        % PenaltyForLoosing=-0.90;
        % PenaltyFullColumn=-1;
        % PenaltyForTie=0;
        % NoWin=0;
    ...
    %% Necessary Methods
    methods              
        function this = Environment_against_minimax_randomOrder()
        ...
        %  STEPS START WITH PLAYER
        function [Observation,Reward,IsDone,LoggedSignals] = step(this,Action) 

            % THE PLAYER STARTS THE GAME:
            if this.agent_starts_game==false
                ...
                action_choice=this.RewardFeasibleAction;
                ...
                % Use the minimax   to select the oponent's piece
                ...
                % board is not full yet.
                    ...
                    if row==-1
                        ...
                        Reward=action_choice; 
                        IsDone=true;
                    else
    
                        % Place the RL piece on the board
                        Board(row, column) = 9;
                        ...
                        if win
                            Reward = this.RewardForWinning +action_choice; 
                            IsDone = true;
        ...
        function InitialObservation = reset(this)
            ...
            if rand() < 0.5
                % RL agent starts
                this.agent_starts_game= true;
            else
                % Opponent player starts
                this.agent_starts_game= false;
            end
